...
const ReCard = ({ recipe, bg, badge }) => {
  const healthLabels = getlabel(recipe.healthLabels);
      ...
      >
        ...
        >
          ...
          <div
            ...
            onClick={(e) => {
              e.preventDefault(); //this lines helps us to prevent the default behaviour of the anchor tag
